    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <StatCard title="Total Registrations" value={stats.total} bgColor="bg-[#fff4e6]" iconColor="text-amber-500" />
                <StatCard title="Last 7 Days" value={stats.last7Days} bgColor="bg-[#e6f7f1]" iconColor="text-emerald-500" />
                <StatCard title="Total Players" value={stats.totalPlayers} bgColor="bg-[#e6f2ff]" iconColor="text-blue-500" />
            </div>

            <div className="bg-[var(--color-surface)] rounded-lg border border-[var(--color-border)] p-6">
                <h3 className="font-semibold text-[var(--color-text-primary)] mb-4">Registrations by Category</h3>
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="bg-[var(--color-background)]">
                                <th className="px-4 py-3 text-left text-xs font-medium text-[var(--color-text-secondary)] uppercase">Team</th>
